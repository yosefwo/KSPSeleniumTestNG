...
public class DataProviderExel {
    ...
    public static Object[][] col_exelData(Method method) throws IOException {
        ...
        switch (method.getName()) {
            ...
            case "register_negativ_enterOnlyMailAdress_submit" -> sheetName = "email address invalid";
            case "example1" -> sheetName = "example sheet name1";
            case "example2" -> sheetName = "example sheet name2";
        }
     ...
     */
    private static Object[][] get_exelData(String sheetName, int startRow, int lastRow, String startColumn, String lastColumn) throws IOException {
